        ...
        <section  id="work" className="c-space my-20">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                ...
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                    ...
                    <div className="p-3 backdrop-filter backdrop-blur-3xl w-fit rounded-lg bg-white-800" style={currentProject.logoStyle}>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a className="flex items-center gap-2 cursor-pointer text-white-600" href={currentProject.href} target="_blank" rel="noreferrer noopener">
                            <p>Check Live Site</p>
