...
const Hero = () => {
    ...
    return (
        <section id="home" className="min-h-screen w-full flex flex-col relative">
            <div className="w-full mx-auto flex flex-col sm:mt-24 mt-20 c-space sm:gap-3 gap-2">
                ...
                <p className="text-center sm:text-xl text-red-900">Note: This is a personal learning project and not a commercial website.</p>
            </div>
